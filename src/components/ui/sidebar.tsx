  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "hidden md:flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground border-r",
            className
          )}
          ref={ref}
          {...props}
      ...
      >
        ...
        <div
          className={cn(
            ...
            collapsible === 'none' ? "w-[--sidebar-width]" : "w-0",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "flex-1 bg-background relative flex flex-col",
        className
      )}
      {...props}
    />
