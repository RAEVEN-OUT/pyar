...
>(({ className, ...props }, ref) => {
  ...
  return (
    <main
      ref={ref}
      className={cn(
        "flex-1 bg-background relative flex flex-col transition-[margin-left] duration-200 ease-linear",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-2 flex h-5 w-5 items-center justify-center rounded-full bg-primary p-1 text-xs font-medium text-primary-foreground",
      "peer-data-[size=sm]/menu-button:top-1",
